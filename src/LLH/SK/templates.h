...
#ifndef LOWER_LEVEL_LIBRARY_LLH_SK
#define LOWER_LEVEL_LIBRARY_LLH_SK
...
/** Lower Level Hashing Namespace. **/
namespace LLH
{

	/** Skein - Keccak Hashing Templates [SK]. **/
	namespace SK
	{
		
		/** Hashing template for Checksums **/
		template<typename T1>
		inline LLT::uint64 SK64(const T1 pbegin, const T1 pend)
		{
