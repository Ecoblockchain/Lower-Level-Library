...
#ifndef LOWER_LEVEL_LIBRARY_LLT_BIGNUM
#define LOWER_LEVEL_LIBRARY_LLT_BIGNUM
...
#include "uint1024.h"
	...
	public:
		...
		CBigNum(int64 n)            { BN_init(this); if (n >= 0) setulong(n); else setint64(n); }
		...
		void setvch(const std::vector<unsigned char>& vch)
		{
			...
			// BIGNUM's unsigned char stream format expects 4 unsigned chars of
